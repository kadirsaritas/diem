...
sourcesIndex["data_streaming_service"] = {"name":"","files":["data_notification.rs","data_stream.rs","error.rs","lib.rs","stream_progress_tracker.rs","streaming_client.rs","streaming_service.rs"]};
sourcesIndex["debug_interface"] = {"name":"","files":["lib.rs","node_debug_service.rs"]};
sourcesIndex["diem_api"] = {"name":"","files":["accounts.rs","context.rs","events.rs","index.rs","lib.rs","log.rs","page.rs","param.rs","runtime.rs","transactions.rs"]};
...
sourcesIndex["move_bytecode_utils"] = {"name":"","files":["dependency_graph.rs","lib.rs"]};
...
sourcesIndex["network"] = {"name":"","dirs":[{"name":"application","files":["interface.rs","mod.rs","storage.rs","types.rs"]},{"name":"connectivity_manager","files":["builder.rs","mod.rs"]},{"name":"noise","files":["error.rs","fuzzing.rs","handshake.rs","mod.rs","stream.rs"]},{"name":"peer","files":["fuzzing.rs","mod.rs"]},{"name":"peer_manager","files":["builder.rs","conn_notifs_channel.rs","error.rs","mod.rs","senders.rs","transport.rs","types.rs"]},{"name":"protocols","dirs":[{"name":"direct_send","files":["mod.rs"]},{"name":"health_checker","files":["builder.rs","interface.rs","mod.rs"]},{"name":"network","files":["mod.rs"]},{"name":"rpc","files":["error.rs","mod.rs"]},{"name":"wire","dirs":[{"name":"handshake","dirs":[{"name":"v1","files":["mod.rs"]}]},{"name":"messaging","dirs":[{"name":"v1","files":["mod.rs"]}]}],"files":["handshake.rs","messaging.rs","mod.rs"]}],"files":["identity.rs","mod.rs"]},{"name":"testutils","files":["fake_socket.rs","mod.rs"]},{"name":"transport","files":["mod.rs"]}],"files":["constants.rs","counters.rs","error.rs","fuzzing.rs","lib.rs","logging.rs"]};
...
sourcesIndex["read_write_set_types"] = {"name":"","files":["access.rs","lib.rs"]};
...
sourcesIndex["shuffle"] = {"name":"","files":["lib.rs"]};
sourcesIndex["shuffle_custom_move_code"] = {"name":"","files":["lib.rs"]};
sourcesIndex["shuffle_custom_node"] = {"name":"","files":["lib.rs","release.rs","utils.rs"]};
sourcesIndex["shuffle_transaction_builder"] = {"name":"","files":["framework.rs","lib.rs"]};
...
sourcesIndex["storage_service_server"] = {"name":"","files":["lib.rs","network.rs"]};
